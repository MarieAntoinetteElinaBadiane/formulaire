...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'numerocompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'solde', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'partenaire', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'depotcompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'users'];
        }
     ...
     * {@inheritDoc}
     */
    public function getDepotcompte(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDepotcompte', []);

        return parent::getDepotcompte();
    }

    /**
     * {@inheritDoc}
     */
    public function addDepotcompte(\App\Entity\Depot $depotcompte): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addDepotcompte', [$depotcompte]);

        return parent::addDepotcompte($depotcompte);
    }

    /**
     * {@inheritDoc}
     */
    public function removeDepotcompte(\App\Entity\Depot $depotcompte): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeDepotcompte', [$depotcompte]);

        return parent::removeDepotcompte($depotcompte);
    }
